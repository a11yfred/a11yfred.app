...
- [ ] **CHANGELOG.md** — entry added for any meaningful code change
- [ ] **UPDATES.md** — plain-language entry for anything user-facing
- [ ] **TODO.md** — resolved items closed and moved to Resolved section; shorthand expanded before filing
- [ ] **README.md** — project structure matches actual files; phase table updated if status changes
- [ ] **CONTRIBUTING.md** — defect schema matches `corpus.json`; update if fields are added or renamed
- [ ] **MAINTENANCE.md** — add a row to the run log above; add/retire sections as systems change
