...
### Prerequisites
- Google Developer account ($5 one-time registration fee at https://chrome.google.com/webstore/devconsole)
...
### Prerequisites
- Mozilla account (free) at https://addons.mozilla.org/developers
...
3. **Submit at AMO**
   - Go to https://addons.mozilla.org/en-US/developers/addons/submit/
...
4. **Fill in store listing**
   - **Name:** A11yFred
   - **Summary (50 chars max):** Accessible finding reference for web and mobile
...
1. Sign the .xpi with an AMO API key:
   ...
   ```
   (Generate keys at https://addons.mozilla.org/en-US/developers/addon/a11yfred/edit)
