...
- [ ] `detail.copy_all_announce` — added: "Description and remediation copied"
...
- [ ] `detail.reset_all_fields_announce` — added: "Description and remediation reset to original"
- [ ] `detail.edit_lang_warning` — added: "Edits are session-only — switching language or finding will reset them."
- [ ] `settings.wcag_filter_label` — added: "WCAG Version"
- [ ] `settings.wcag_filter_desc` — added: "Filter results by WCAG version."
- [ ] `settings.wcag_filter_legend` — added: "WCAG version filter"
