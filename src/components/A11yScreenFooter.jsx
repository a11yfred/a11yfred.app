    ...
    <footer className="page-footer">
      ...
      <p>
        ...
        >
          ...
          {t('footer.sponsor')}<ExternalLinkIcon size="0.8em" className="inline-icon" aria-hidden="true" /><span className="sr-only"> (opens in new tab)</span>
        </a>
        {'  ·  '}
        <a
          href={URL_LINKEDIN}
        ...
        >
          ...
          {t('footer.linkedin')}<ExternalLinkIcon size="0.8em" className="inline-icon" aria-hidden="true" /><span className="sr-only"> (opens in new tab)</span>
        </a>
      </p>
      <p>
        <a
          ...
          className="footer-link"
        >
          {t('footer.privacy') || 'Privacy'}<ExternalLinkIcon size="0.8em" className="inline-icon" aria-hidden="true" /><span className="sr-only"> (opens in new tab)</span>
        </a>
      </p>
    </footer>
  )
