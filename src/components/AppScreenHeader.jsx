    ...
    <header className={`page-header${compact ? ' page-header--compact' : ''}`} inert={isDesktop && onboardingOpen ? true : undefined}>
      ...
      {!compact && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="link-btn-styled header-link-github"
        >
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
          ...
          {t('header.github')}<ExternalLinkIcon size="0.8em" className="inline-icon footer-ext-icon" aria-hidden="true" /><span className="sr-only"> (opens in new tab)</span>
        </a>
      )}
